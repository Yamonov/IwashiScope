 ...
 * declared optional calibration event callbacks while preserving the original API.
 *
 */
...
typedef enum {
	inst_app_calibration_started,
	inst_app_calibration_prompt,
	inst_app_calibration_complete,
	inst_app_calibration_failed,
	inst_app_calibration_aborted,
	inst_app_calibration_skipped
} inst_app_calibration_event;

typedef void (*inst_app_calibration_callback)(
	void *context,
	inst *p,
