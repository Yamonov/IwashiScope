...
enum MeasurementHistoryDragItemProvider {
    static let aseFileName = "SpectraMate-Lab-Swatches.ase"
    ...
    static func make(
        ...
        // The plain-text identifier is only for SpectraMate's insertion drop
                ...
                do {
                    ...
                    let temporaryDirectory = FileManager.default.temporaryDirectory
                        .appendingPathComponent(
                            "SpectraMate-Drag-\(UUID().uuidString)",
                            isDirectory: true
                        )
