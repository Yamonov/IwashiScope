...
final class SpotreadProcess: @unchecked Sendable {
    private static let forcedTerminationQueue = DispatchQueue(
        label: "com.yamonov.SpectraMate.spotread-termination",
        qos: .userInitiated
    )

    private let lock = NSLock()
    private let inputQueue = DispatchQueue(
        label: "com.yamonov.SpectraMate.spotread-input",
        qos: .userInitiated
    )
    ...
    func start(
        ...
        let protocolReadQueue = DispatchQueue(
            label: "com.yamonov.SpectraMate.spotread-protocol-read",
            qos: .userInitiated
        )
        let logReadQueue = DispatchQueue(
            label: "com.yamonov.SpectraMate.spotread-log-read",
            qos: .userInitiated
        )
